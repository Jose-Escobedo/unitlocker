...
const steps = [
  {
    ...
    detail: 'Join UnitLocker and get access to the daily picks feed — CS2, NBA, NHL, MLB, NFL, and Tennis props posted by staff.',
    stat: '< 1 min',
  ...
  },
  {
    ...
    desc: 'Fresh prop picks posted daily. Filter by sport, see the line, and check the player history.',
  ...
  },
  {
    ...
    desc: 'See the line, the Over/Under call, and the player history. Check L5, L10, and H2H hit rates.',
    detail: 'Each card shows the player, stat, line, and an Over/Under call. Staff picks include context notes and a L5/L10/H2H history chart so you can see exactly why the pick was made.',
    stat: 'L5·L10·H2H',
    statLabel: 'history filters',
  },
 {
  number: '04',
  icon: CheckCircle,
