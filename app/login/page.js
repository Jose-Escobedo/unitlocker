      ...
      >
        ...
        <div className="relative flex flex-col gap-6">
          ...
          >
            Welcome back.
            <br />
            <span style={{ color: '#00e5a0' }}>Your edge awaits.</span>
          </h2>
          <p
            className="text-sm leading-relaxed max-w-sm"
            style={{ color: '#5a6474', fontFamily: "'DM Sans', sans-serif" }}
          >
            Log back in to pick up where you left off — your bankroll, your bets, your progress. All waiting for you.
          </p>

          {/* Stats */}
          <div className="flex flex-col gap-3 mt-2">
            {[
              'Your bankroll tracked in real time',
              'Full bet history always available',
              'Streaks, XP & ranks preserved',
            ].map((item, i) => (
